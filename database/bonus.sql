...
(
	...
	where f.name = "ACUNA NEVAREZ, O" and (progress_date BETWEEN  DATE_SUB('2015-03-29', INTERVAL 1 WEEK) AND '2015-03-29')
...
(
	...
	from entry e
	left join foreman f on f.id = e.foreman_id
	where f.name = "ACUNA NEVAREZ, O" and (progress_date BETWEEN  DATE_SUB('2015-03-29', INTERVAL 2 WEEK) AND DATE_SUB('2015-03-29', INTERVAL 1 WEEK) )
...
(
	...
	from entry e
	left join foreman f on f.id = e.foreman_id
	where f.name = "ACUNA NEVAREZ, O" and (progress_date BETWEEN  DATE_SUB('2015-03-29', INTERVAL 3 WEEK) AND DATE_SUB('2015-03-29', INTERVAL 2 WEEK) )
...
(
	...
	from entry e
	left join foreman f on f.id = e.foreman_id
	where f.name = "ACUNA NEVAREZ, O" and (progress_date BETWEEN  DATE_SUB('2015-03-29', INTERVAL 4 WEEK) AND DATE_SUB('2015-03-29', INTERVAL 3 WEEK) )
...
(
	...
	from entry e
	left join foreman f on f.id = e.foreman_id
	where f.name = "ACUNA NEVAREZ, O" and (progress_date BETWEEN  DATE_SUB('2015-03-29', INTERVAL 5 WEEK) AND DATE_SUB('2015-03-29', INTERVAL 4 WEEK) )
...
(
	...
	from entry e
	left join foreman f on f.id = e.foreman_id
	where f.name = "ACUNA NEVAREZ, O" and (progress_date BETWEEN  DATE_SUB('2015-03-29', INTERVAL 6 WEEK) AND DATE_SUB('2015-03-29', INTERVAL 5 WEEK) )
...
(
	...
	from entry e
	left join foreman f on f.id = e.foreman_id
	where f.name = "ACUNA NEVAREZ, O" and (progress_date BETWEEN  DATE_SUB('2015-03-29', INTERVAL 7 WEEK) AND DATE_SUB('2015-03-29', INTERVAL 6 WEEK) )
...
(
	...
	from entry e
	left join foreman f on f.id = e.foreman_id
	where f.name = "ACUNA NEVAREZ, O" and (progress_date BETWEEN  DATE_SUB('2015-03-29', INTERVAL 8 WEEK) AND DATE_SUB('2015-03-29', INTERVAL 7 WEEK) )
...
(
	...
	from entry e
	left join foreman f on f.id = e.foreman_id
	where f.name = "ACUNA NEVAREZ, O" and (progress_date BETWEEN  DATE_SUB('2015-03-29', INTERVAL 9 WEEK) AND DATE_SUB('2015-03-29', INTERVAL 8 WEEK) )
...
(
	...
	from entry e
	left join foreman f on f.id = e.foreman_id
	where f.name = "ACUNA NEVAREZ, O" and (progress_date BETWEEN  DATE_SUB('2015-03-29', INTERVAL 10 WEEK) AND DATE_SUB('2015-03-29', INTERVAL 9 WEEK) )
